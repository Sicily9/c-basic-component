...
int main(int argc,char *argv[])
{
    ...
    while(1){
		...
		Bizserver bizserver;
		bizserver__init(&bizserver);

		bizserver.protocol = malloc(4);
		strcpy(bizserver.protocol, "http");

		bizserver.address = malloc(15);
		strcpy(bizserver.address, "192.168.38.55");

		bizserver.port = malloc(5);
